...
Route::delete('/posts/{post}', [PostController::class, 'destroy'])->name('posts.destroy')->middleware('auth', 'can:isAdmin'); /* (https://laravel.com/docs/4.2/routing#route-model-binding) */

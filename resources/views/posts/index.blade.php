  ...
  <div class="w-8/12 bg-purple-100 p-6 rounded-lg">
    ...
    <div class="flex flex-row w-12/12 justify-between ">
      ...
      <a href="{{route('posts.create')}}">
        <button
          class="transform motion-safe:hover:scale-110 mb-2 text-white bg-purple-500 text-2xl py-2 px-3 rounded-xl hover:bg-purple-600"><i
            class="fas fa-plus fa-1x mr-1 text-white"></i> Create Post</button>
      </a>
      @endauth
    </div>
